...
if __name__ == "__main__":
    ...
    red_sub_split = [200, 494]
    green_sub_split = [200, 57]
    rng_sub_split = [20, 29]

    train, valid = split_file_list([red_sub_split, green_sub_split, rng_sub_split])
    print(len(train), len(valid))

    write_file("train_sub", train)
    write_file("valid_sub", valid)